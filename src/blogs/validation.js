...
const schema = {
  title: {
    in: ["body"],
    isString: { errorMessage: "validation failed, type must be string" },
  },
  category: {
    in: ["body"],
    isString: { errorMessage: "validation failed, type must be string" },
...
const commentSchema = {
  text: {
    isString: { errorMessage: "text field is required for comment" },
  },
  userName: {
    isString: { errorMessage: "user name is required for comment" },
  },
};
